...
export default {
  ...
  manageQuotations:"إدارة العروض و المقترحات",
  issued:"صادر",
  atLeastOneDescriptionRequired:"مطلوب وجود عنصر واحد على الأقل مع وصف",
  enterPaymentAmount:"أدخل مبلغ الدفع",
  remainingLabel:"المتبقي",
  paymentRegisteredSuccessfully:"تم تسجيل الدفع بنجاح",
  paymentFailed:"فشل الدفع",
  createFromQuotation:"إنشاء من عروض الأسعار المقبولة",
  manageInvoices:"إدارة الفواتير والمدفوعات",
  items:"العناصر",
  statisticsStat:"الإحصائيات",
  accepted:"مقبول",
  ...
  next:"التالي",
  issue:"إصدار",
  pleaseSelectAClient:"يرجى اختيار العميل",
  failedToSaveDevis:"فشل حفظ عرض السعر",
  currencyDA:"دج",
  item:"عنصر",
  registerPayment:"تسجيل دفع",
  length:"الطول (م)",
  width:"العرض (م)",
  consumption: "الاستهلاك (كغ/م²)",
  surface: "المساحة (م²)",
