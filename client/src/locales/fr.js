...
export default {
  ...
  invoiceSavedSuccessfully:"Facture enregistrée avec succès",
  ...
  issued:"Émis",
  atLeastOneDescriptionRequired:"Au moins un article avec une description est requis",
  enterPaymentAmount:"Entrez le montant du paiement",
  remainingLabel:"Restant",
  paymentRegisteredSuccessfully:"Paiement enregistré avec succès",
  paymentFailed:"Échec du paiement",
  createFromQuotation:"Créer à partir de devis acceptés",
  manageInvoices:"Gérer les factures et paiements",
  project:"Projet",
  ...
  manageQuotations:"Gérer les devis et propositions",
  statisticsStat:"Statistiques",
  accepted:"Accepté",
  ...
  failedToSaveDevis:"Échec de l'enregistrement du devis",
  currencyDA:"DA",
  item:"Article",
  registerPayment:"Enregistrer un paiement",
  length:"Longueur (m)",
  width:"Largeur (m)",
  consumption: "Consommation (kg/m²)",
  surface: "Surface (m²)",
